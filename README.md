...
A small, static portfolio led by FluentAI, with real project previews and direct links.
...
- `assets/portfolio-social-fluentai.png`: social preview.
...
FluentAI leads the page with its narrated walkthrough and a direct link to the [LinkedIn award story](https://www.linkedin.com/feed/update/urn:li:activity:7469743099322216448/). The post confirms the Ralphthon @SG Impact Prize, $5,000 in OpenAI API credits and $1,500 in Network School credits. These are credits, not cash.

The page links to six other live project sites and three narrated walkthroughs with native players, captions, and transcripts. The Curio, FluentAI, and iGhost recordings use actual OpenAI API responses captured on 13 September 2026; Curio and iGhost retain the speech generated by the apps. Source repositories document the calls and capture method. Interactive demos, generated-data demos, reports, and early prototypes are labeled separately. The evaluation report is a deterministic comparison without an LLM.
