...
- `assets/portfolio-social-v3.png`: social preview.
...
The page links to six live project sites and three narrated walkthroughs with native players, captions, and transcripts. The Curio, FluentAI, and iGhost recordings use actual OpenAI API responses captured on 13 September 2026; Curio and iGhost retain the speech generated by the apps. Source repositories document the calls and capture method. Interactive demos, generated-data demos, reports, and early prototypes are labeled separately. The evaluation report is a deterministic comparison without an LLM.

A compact featured-post card below the personal introduction links to the [FluentAI LinkedIn story](https://www.linkedin.com/feed/update/urn:li:activity:7469743099322216448/). Its Impact Prize details are $5,000 in OpenAI API credits and $1,500 in Network School credits. The original personal introduction, project gallery and three-video walkthrough section remain the main structure.
